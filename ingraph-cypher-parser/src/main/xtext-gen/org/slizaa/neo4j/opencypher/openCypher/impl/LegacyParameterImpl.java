 ...
 * </p>
 * <ul>
 *   <li>{@link org.slizaa.neo4j.opencypher.openCypher.impl.LegacyParameterImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link org.slizaa.neo4j.opencypher.openCypher.impl.LegacyParameterImpl#getNodeLabels <em>Node Labels</em>}</li>
 *   <li>{@link org.slizaa.neo4j.opencypher.openCypher.impl.LegacyParameterImpl#getOperator <em>Operator</em>}</li>
...
public class LegacyParameterImpl extends PropertiesImpl implements LegacyParameter
{
  ...
  public NotificationChain basicSetVariable(Variable newVariable, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenCypherPackage.LEGACY_PARAMETER__VARIABLE, oldVariable, newVariable);
  ...
  public void setVariable(Variable newVariable)
  {
    if (newVariable != variable)
    {
      ...
      if (variable != null)
        msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.LEGACY_PARAMETER__VARIABLE, null, msgs);
      if (newVariable != null)
        msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.LEGACY_PARAMETER__VARIABLE, null, msgs);
      msgs = basicSetVariable(newVariable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OpenCypherPackage.LEGACY_PARAMETER__VARIABLE, newVariable, newVariable));
  }
  ...
  public NotificationChain basicSetNodeLabels(NodeLabels newNodeLabels, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS, oldNodeLabels, newNodeLabels);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setNodeLabels(NodeLabels newNodeLabels)
  {
    if (newNodeLabels != nodeLabels)
    {
      NotificationChain msgs = null;
      if (nodeLabels != null)
        msgs = ((InternalEObject)nodeLabels).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS, null, msgs);
      if (newNodeLabels != null)
        msgs = ((InternalEObject)newNodeLabels).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS, null, msgs);
      msgs = basicSetNodeLabels(newNodeLabels, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS, newNodeLabels, newNodeLabels));
  }
  ...
  public void setOperator(String newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OpenCypherPackage.LEGACY_PARAMETER__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OpenCypherPackage.LEGACY_PARAMETER__LEFT, oldLeft, newLeft);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLeft(Expression newLeft)
  {
    if (newLeft != left)
    {
      NotificationChain msgs = null;
      if (left != null)
        msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.LEGACY_PARAMETER__LEFT, null, msgs);
      if (newLeft != null)
        msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OpenCypherPackage.LEGACY_PARAMETER__LEFT, null, msgs);
      msgs = basicSetLeft(newLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OpenCypherPackage.LEGACY_PARAMETER__LEFT, newLeft, newLeft));
  }
  ...
  public EList<Expression3Part> getExpression3Parts()
  {
    ...
    {
      expression3Parts = new EObjectContainmentEList<Expression3Part>(Expression3Part.class, this, OpenCypherPackage.LEGACY_PARAMETER__EXPRESSION3_PARTS);
    }
  ...
  public EList<NodeLabel> getNodeLabelList()
  {
    ...
    {
      nodeLabelList = new EObjectContainmentEList<NodeLabel>(NodeLabel.class, this, OpenCypherPackage.LEGACY_PARAMETER__NODE_LABEL_LIST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OpenCypherPackage.LEGACY_PARAMETER__VARIABLE:
        return basicSetVariable(null, msgs);
      case OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS:
        return basicSetNodeLabels(null, msgs);
      case OpenCypherPackage.LEGACY_PARAMETER__LEFT:
        return basicSetLeft(null, msgs);
      case OpenCypherPackage.LEGACY_PARAMETER__EXPRESSION3_PARTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case OpenCypherPackage.LEGACY_PARAMETER__OPERATOR:
        return getOperator();
      case OpenCypherPackage.LEGACY_PARAMETER__LEFT:
        return getLeft();
      case OpenCypherPackage.LEGACY_PARAMETER__EXPRESSION3_PARTS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == RemoveItem.class)
    {
      ...
      {
        case OpenCypherPackage.LEGACY_PARAMETER__VARIABLE: return OpenCypherPackage.REMOVE_ITEM__VARIABLE;
        case OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS: return OpenCypherPackage.REMOVE_ITEM__NODE_LABELS;
        default: return -1;
      }
    }
    ...
    if (baseClass == Expression.class)
    {
      switch (derivedFeatureID)
      {
        case OpenCypherPackage.LEGACY_PARAMETER__OPERATOR: return OpenCypherPackage.EXPRESSION__OPERATOR;
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == RemoveItem.class)
    {
      ...
      {
        case OpenCypherPackage.REMOVE_ITEM__VARIABLE: return OpenCypherPackage.LEGACY_PARAMETER__VARIABLE;
        case OpenCypherPackage.REMOVE_ITEM__NODE_LABELS: return OpenCypherPackage.LEGACY_PARAMETER__NODE_LABELS;
        default: return -1;
      }
    }
    if (baseClass == PropertyExpression.class)
    ...
    if (baseClass == Expression.class)
    {
      switch (baseFeatureID)
      {
        case OpenCypherPackage.EXPRESSION__OPERATOR: return OpenCypherPackage.LEGACY_PARAMETER__OPERATOR;
