...
\begin{flalign*}
& \projection{\var{a}} \Big(\selection{\var{a.name} = \literal{''Andres''}} \Big(\alldifferent{} \Big(\expandboth{\_e27}{a}{}{rel}{X}{1}{1} \Big(\getvertices{\_e27}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{x}} \Big(\alldifferent{} \Big(\expandout{\_e28}{x}{}{rel}{KNOWS}{1}{1} \Big(\getvertices{\_e28}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandout{\_e29}{\_e30}{}{r}{}{1}{1} \Big(\getvertices{\_e29}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{b},~\var{c}} \Big(\alldifferent{} \Big(\expandout{b}{c}{}{\_e34}{FRIEND}{0}{1} \Big(\expandout{a}{b}{}{\_e33}{CONTAINS}{0}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{foo}} \Big(\alldifferent{} \Big(\getvertices{a}{}\Big) \join \alldifferent{} \Big(\expandout{\_e36}{foo}{}{\_e38}{KNOWS}{1}{1} \Big(\expandout{a}{\_e36}{}{\_e37}{KNOWS}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{\_e39}{}{r}{}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{b}} \Big(\alldifferent{} \Big(\expandout{a}{b}{}{\_e41}{T}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{n},~\var{x}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big) \join \alldifferent{} \Big(\expandout{n}{x}{}{\_e42}{NOT\_EXIST}{1}{1} \Big(\getvertices{n}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandout{\_e45}{\_e46}{B}{r}{}{1}{1} \Big(\getvertices{\_e45}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a.name}} \Big(\alldifferent{} \Big(\expandout{\_e51}{a}{}{\_e53}{B}{1}{1} \Big(\expandout{a}{\_e51}{}{\_e52}{A}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a.name}} \Big(\alldifferent{} \Big(\expandout{a}{b}{}{\_e54}{A}{1}{1} \Big(\getvertices{a}{}\Big) \join \expandout{b}{a}{}{\_e55}{B}{1}{1} \Big(\getvertices{b}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r2}} \Big(\alldifferent{} \Big(\expandout{\_e56}{\_e57}{}{r1}{}{1}{1} \Big(\getvertices{\_e56}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{\_e58}{\_e59}{}{r2}{}{1}{1} \Big(\getvertices{\_e58}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r2}} \Big(\alldifferent{} \Big(\expandout{\_e60}{\_e61}{}{r1}{}{1}{1} \Big(\getvertices{\_e60}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{\_e62}{\_e63}{}{r2}{}{1}{1} \Big(\getvertices{\_e62}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a2},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{\_e64}{\_e65}{}{r}{}{1}{1} \Big(\getvertices{\_e64}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a2}{b2}{}{r}{}{1}{1} \Big(\getvertices{a2}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e66}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e67}{}{r}{}{1}{1} \Big(\getvertices{a1}{X}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{X}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e68}{}{r}{}{1}{1} \Big(\getvertices{a1}{X \land Y}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{X \land Y}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e69}{}{r}{CONTRADICTING LABEL CONSTRAINTS}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{CONTRADICTING LABEL CONSTRAINTS}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e70}{}{r}{T}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{T}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e76}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandin{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2},~\var{a2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e77}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \selection{\var{a1} = \var{a2}} \Big(\alldifferent{} \Big(\expandin{a2}{b2}{}{r}{}{1}{1} \Big(\getvertices{a2}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \topp{4}{} \Big(\sort{\desc \atom{x}} \Big(\projection{\var{foo.bar}} \Big(\alldifferent{} \Big(\getvertices{foo}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r.prop}} \Big(\alldifferent{} \Big(\expandout{\_e81}{\_e82}{}{r}{}{1}{1} \Big(\getvertices{\_e81}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{r}} \Big(\alldifferent{} \Big(\expandout{a}{\_e83}{}{r}{}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r.bar}} \Big(\alldifferent{} \Big(\expandout{\_e84}{\_e85}{}{r}{}{1}{1} \Big(\getvertices{\_e84}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{n},~\var{m}} \Big(\alldifferent{} \Big(\expandout{n}{m}{Z \land Y \land X \land W \land V \land U}{\_e90}{T}{1}{1} \Big(\getvertices{n}{A \land B \land C \land D \land E \land F \land G \land H \land I \land J \land K \land L \land M}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{b}} \Big(\alldifferent{} \Big(\getvertices{a}{Single}\Big) \join \alldifferent{} \Big(\expandboth{a}{b}{}{\_e98}{}{3}{} \Big(\getvertices{a}{Single}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \sort{\desc \atom{id}} \Big(\duplicateelimination \Big(\projection{\var{n.id}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a}{b1}{}{\_e121}{X}{1}{1} \Big(\getvertices{a}{S}\Big)\Big) \join \alldifferent{} \Big(\expandout{a}{b2}{}{\_e122}{Y}{1}{1} \Big(\getvertices{a}{S}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e125}{LIKES}{0}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e126}{LIKES}{1}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e127}{LIKES}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e128}{LIKES}{0}{2} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e129}{LIKES}{1}{2} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e130}{LIKES}{0}{0} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e131}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e132}{LIKES}{2}{2} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e133}{LIKES}{2}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e134}{LIKES}{1}{0} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e138}{LIKES}{0}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e139}{LIKES}{1}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e140}{LIKES}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e141}{c}{}{\_e143}{LIKES}{1}{1} \Big(\expandout{a}{\_e141}{}{\_e142}{LIKES}{0}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e144}{c}{}{\_e146}{LIKES}{0}{} \Big(\expandout{a}{\_e144}{}{\_e145}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e147}{c}{}{\_e149}{LIKES}{1}{1} \Big(\expandout{a}{\_e147}{}{\_e148}{LIKES}{1}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e150}{c}{}{\_e152}{LIKES}{1}{} \Big(\expandout{a}{\_e150}{}{\_e151}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e153}{c}{}{\_e155}{LIKES}{1}{1} \Big(\expandout{a}{\_e153}{}{\_e154}{LIKES}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e156}{c}{}{\_e158}{LIKES}{2}{} \Big(\expandout{a}{\_e156}{}{\_e157}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e159}{c}{}{\_e161}{LIKES}{3}{} \Big(\expandout{a}{\_e159}{}{\_e160}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e162}{c}{}{\_e164}{LIKES}{3}{} \Big(\expandin{a}{\_e162}{}{\_e163}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandboth{\_e165}{c}{}{\_e167}{LIKES}{3}{} \Big(\expandout{a}{\_e165}{}{\_e166}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e170}{c}{}{r}{LIKES}{2}{} \Big(\expandout{\_e168}{\_e170}{}{\_e171}{LIKES}{1}{1} \Big(\expandout{p}{\_e168}{}{\_e169}{LIKES}{1}{} \Big(\getvertices{p}{}\Big)\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e174}{c}{}{r}{LIKES}{1}{1} \Big(\expandout{\_e172}{\_e174}{}{\_e175}{LIKES}{2}{} \Big(\expandout{p}{\_e172}{}{\_e173}{LIKES}{1}{1} \Big(\getvertices{p}{}\Big)\Big)\Big)\Big)\Big)
 &
\end{flalign*}
