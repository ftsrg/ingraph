...
\begin{flalign*}
& \projection{\var{n}\assign \var{value}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big)\Big)
 &
\end{flalign*}
...
[
	{$\projection{\var{n}\assign \var{value}}$
			\\
			\footnotesize
...
\begin{flalign*}
& \projection{\var{n.value}\assign \var{n},~\var{m.value}\assign \var{m}} \Big(\alldifferent{} \Big(\getvertices{n}{} \join \getvertices{m}{}\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a}} \Big(\selection{\var{a.name} = \literal{''Andres''}} \Big(\alldifferent{} \Big(\expandboth{\_e155}{a}{}{rel}{X}{1}{1} \Big(\getvertices{\_e155}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\selection{\var{a.name} = \literal{''Andres''}}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e155, rel, a} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\getvertices{\_e155}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e155} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{a}} \Big(\selection{\var{r.name} = \literal{''monkey''}} \Big(\alldifferent{} \Big(\expandout{node}{a}{}{r}{KNOWS}{1}{1} \Big(\getvertices{node}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{n1},~\var{n2}} \Big(\alldifferent{} \Big(\expandout{n1}{n2}{}{rel}{KNOWS}{1}{1} \Big(\getvertices{n1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{x}} \Big(\alldifferent{} \Big(\expandout{\_e156}{x}{}{rel}{KNOWS}{1}{1} \Big(\getvertices{\_e156}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e156, rel, x} \rangle$
			}
[
	{$\expandout{\_e156}{x}{}{rel}{KNOWS}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e156, rel, x} \rangle$
			}
[
	{$\getvertices{\_e156}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e156} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{n},~\var{x}} \Big(\selection{\var{n.animal} = \var{x.animal}} \Big(\alldifferent{} \Big(\expandout{n}{x}{}{rel}{}{1}{1} \Big(\getvertices{n}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{b}} \Big(\alldifferent{} \Big(\expandboth{a}{b}{}{r}{}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{b},~\var{c}} \Big(\alldifferent{} \Big(\expandboth{a}{b}{}{r}{}{1}{1} \Big(\getvertices{a}{}\Big)\Big) \join \selection{\var{r} \neq \var{r2}} \Big(\alldifferent{} \Big(\expandboth{b}{c}{}{r2}{}{1}{1} \Big(\getvertices{b}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandout{a}{b}{End}{r}{REL}{2}{2} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandboth{a}{b}{End}{r}{REL}{2}{2} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandboth{a}{b}{}{r}{REL}{2}{2} \Big(\getvertices{a}{Start}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \topp{}{0} \Big(\projection{\var{n}} \Big(\selection{\literal{1} = \literal{0}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandout{\_e157}{\_e158}{}{r}{}{1}{1} \Big(\getvertices{\_e157}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e157, r, \_e158} \rangle$
			}
[
	{$\expandout{\_e157}{\_e158}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e157, r, \_e158} \rangle$
			}
[
	{$\getvertices{\_e157}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e157} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{a},~\var{b},~\var{c}} \Big(\alldifferent{} \Big(\expandout{b}{c}{}{\_e162}{FRIEND}{0}{1} \Big(\expandout{a}{b}{}{\_e161}{CONTAINS}{0}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e161, b, \_e162, c} \rangle$
			}
[
	{$\expandout{b}{c}{}{\_e162}{FRIEND}{0}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e161, b, \_e162, c} \rangle$
			}
[
	{$\expandout{a}{b}{}{\_e161}{CONTAINS}{0}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e161, b} \rangle$
			}
[
	{$\getvertices{a}{}$
			\\
...
\begin{flalign*}
& \projection{\var{foo}} \Big(\alldifferent{} \Big(\getvertices{a}{}\Big) \join \alldifferent{} \Big(\expandout{\_e164}{foo}{}{\_e166}{KNOWS}{1}{1} \Big(\expandout{a}{\_e164}{}{\_e165}{KNOWS}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e165, \_e164, \_e166, foo} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e164}{foo}{}{\_e166}{KNOWS}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e165, \_e164, \_e166, foo} \rangle$
			}
[
	{$\expandout{a}{\_e164}{}{\_e165}{KNOWS}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e165, \_e164} \rangle$
			}
[
	{$\getvertices{a}{}$
			\\
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{\_e167}{}{r}{}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, r, \_e167} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{other}} \Big(\alldifferent{} \Big(\getvertices{a}{A} \join \getvertices{other}{B}\Big) \join \alldifferent{} \Big(\expandout{a}{other}{B}{r}{}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{b}} \Big(\alldifferent{} \Big(\expandout{a}{b}{}{\_e169}{T}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e169, b} \rangle$
			}
[
	{$\expandout{a}{b}{}{\_e169}{T}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e169, b} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{n},~\var{x}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big) \join \alldifferent{} \Big(\expandout{n}{x}{}{\_e170}{NOT\_EXIST}{1}{1} \Big(\getvertices{n}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{n, \_e170, x} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{n}{x}{}{\_e170}{NOT\_EXIST}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{n, \_e170, x} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandout{\_e173}{\_e174}{B}{r}{}{1}{1} \Big(\getvertices{\_e173}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e173, r, \_e174} \rangle$
			}
[
	{$\expandout{\_e173}{\_e174}{B}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e173, r, \_e174} \rangle$
			}
[
	{$\getvertices{\_e173}{A}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e173} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{a}} \Big(\alldifferent{} \Big(\getvertices{a}{A \land B \land C}\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a.name}} \Big(\alldifferent{} \Big(\expandout{\_e179}{a}{}{\_e181}{B}{1}{1} \Big(\expandout{a}{\_e179}{}{\_e180}{A}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e180, \_e179, \_e181} \rangle$
			}
[
	{$\expandout{\_e179}{a}{}{\_e181}{B}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e180, \_e179, \_e181} \rangle$
			}
[
	{$\expandout{a}{\_e179}{}{\_e180}{A}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e180, \_e179} \rangle$
			}
[
	{$\getvertices{a}{}$
			\\
...
\begin{flalign*}
& \projection{\var{a.name}} \Big(\alldifferent{} \Big(\expandout{a}{b}{}{\_e182}{A}{1}{1} \Big(\getvertices{a}{}\Big) \join \expandout{b}{a}{}{\_e183}{B}{1}{1} \Big(\getvertices{b}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e182, b, \_e183} \rangle$
			}
[
	{$\join$
			\\
...
[
	{$\expandout{a}{b}{}{\_e182}{A}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e182, b} \rangle$
			}
[
	{$\getvertices{a}{}$
			\\
...
[
	{$\expandout{b}{a}{}{\_e183}{B}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{b, \_e183, a} \rangle$
			}
[
	{$\getvertices{b}{}$
			\\
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\expandout{a}{b}{}{r}{}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r2}\assign \var{rel}} \Big(\alldifferent{} \Big(\expandout{\_e184}{\_e185}{}{r1}{}{1}{1} \Big(\getvertices{\_e184}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{\_e186}{\_e187}{}{r2}{}{1}{1} \Big(\getvertices{\_e186}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e184, r1, \_e185, \_e186, r2, \_e187} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e184, r1, \_e185} \rangle$
			}
[
	{$\expandout{\_e184}{\_e185}{}{r1}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e184, r1, \_e185} \rangle$
			}
[
	{$\getvertices{\_e184}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e184} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e186, r2, \_e187} \rangle$
			}
[
	{$\expandout{\_e186}{\_e187}{}{r2}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e186, r2, \_e187} \rangle$
			}
[
	{$\getvertices{\_e186}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e186} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{r2}\assign \var{rel}} \Big(\alldifferent{} \Big(\expandout{\_e188}{\_e189}{}{r1}{}{1}{1} \Big(\getvertices{\_e188}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{\_e190}{\_e191}{}{r2}{}{1}{1} \Big(\getvertices{\_e190}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e188, r1, \_e189, \_e190, r2, \_e191} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e188, r1, \_e189} \rangle$
			}
[
	{$\expandout{\_e188}{\_e189}{}{r1}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e188, r1, \_e189} \rangle$
			}
[
	{$\getvertices{\_e188}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e188} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e190, r2, \_e191} \rangle$
			}
[
	{$\expandout{\_e190}{\_e191}{}{r2}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e190, r2, \_e191} \rangle$
			}
[
	{$\getvertices{\_e190}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e190} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{a2},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{\_e192}{\_e193}{}{r}{}{1}{1} \Big(\getvertices{\_e192}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a2}{b2}{}{r}{}{1}{1} \Big(\getvertices{a2}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e192, r, \_e193, a2, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e192, r, \_e193} \rangle$
			}
[
	{$\expandout{\_e192}{\_e193}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e192, r, \_e193} \rangle$
			}
[
	{$\getvertices{\_e192}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e192} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e194}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e194, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e194} \rangle$
			}
[
	{$\expandout{a1}{\_e194}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e194} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e195}{}{r}{}{1}{1} \Big(\getvertices{a1}{X}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{X}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e195, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e195} \rangle$
			}
[
	{$\expandout{a1}{\_e195}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e195} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e196}{}{r}{}{1}{1} \Big(\getvertices{a1}{X \land Y}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{X \land Y}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e196, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e196} \rangle$
			}
[
	{$\expandout{a1}{\_e196}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e196} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e197}{}{r}{CONTRADICTING LABEL CONSTRAINTS}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{CONTRADICTING LABEL CONSTRAINTS}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e197, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e197} \rangle$
			}
[
	{$\expandout{a1}{\_e197}{}{r}{CONTRADICTING LABEL CONSTRAINTS}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e197} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e198}{}{r}{T}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandout{a1}{b2}{}{r}{T}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e198, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e198} \rangle$
			}
[
	{$\expandout{a1}{\_e198}{}{r}{T}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e198} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e204}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \alldifferent{} \Big(\expandin{a1}{b2}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e204, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e204} \rangle$
			}
[
	{$\expandout{a1}{\_e204}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e204} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{a1},~\var{r},~\var{b2},~\var{a2}} \Big(\alldifferent{} \Big(\expandout{a1}{\_e205}{}{r}{}{1}{1} \Big(\getvertices{a1}{}\Big)\Big) \join \selection{\var{a1} = \var{a2}} \Big(\alldifferent{} \Big(\expandin{a2}{b2}{}{r}{}{1}{1} \Big(\getvertices{a2}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e205, a2, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e205} \rangle$
			}
[
	{$\expandout{a1}{\_e205}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a1, r, \_e205} \rangle$
			}
...
\begin{flalign*}
& \topp{4}{} \Big(\sort{\desc \var{x}} \Big(\projection{\var{foo.bar}\assign \var{x}} \Big(\alldifferent{} \Big(\getvertices{foo}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{r.prop}} \Big(\alldifferent{} \Big(\expandout{\_e209}{\_e210}{}{r}{}{1}{1} \Big(\getvertices{\_e209}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e209, r, \_e210} \rangle$
			}
[
	{$\expandout{\_e209}{\_e210}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e209, r, \_e210} \rangle$
			}
[
	{$\getvertices{\_e209}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{\_e209} \rangle$
			},tier=input,for tree={blue,densely dashed}
]
]
]
...
\begin{flalign*}
& \projection{\var{a}\assign \var{foo},~\var{r}\assign \var{bar}} \Big(\alldifferent{} \Big(\expandout{a}{\_e211}{}{r}{}{1}{1} \Big(\getvertices{a}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, r, \_e211} \rangle$
			}
[
	{$\expandout{a}{\_e211}{}{r}{}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, r, \_e211} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{r.bar}} \Big(\alldifferent{} \Big(\expandout{\_e212}{\_e213}{}{r}{}{1}{1} \Big(\getvertices{\_e212}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{n},~\var{m}} \Big(\alldifferent{} \Big(\expandout{n}{m}{Z \land Y \land X \land W \land V \land U}{\_e218}{T}{1}{1} \Big(\getvertices{n}{A \land B \land C \land D \land E \land F \land G \land H \land I \land J \land K \land L \land M}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{n, \_e218, m} \rangle$
			}
[
	{$\expandout{n}{m}{Z \land Y \land X \land W \land V \land U}{\_e218}{T}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{n, \_e218, m} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\getvertices{n}{Single}\Big) \join \alldifferent{} \Big(\expandboth{n}{m}{NonExistent}{r}{}{1}{1} \Big(\getvertices{n}{Single}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{m}} \Big(\alldifferent{} \Big(\getvertices{n}{Single}\Big) \join \selection{\var{m.prop} = \literal{42}} \Big(\alldifferent{} \Big(\expandboth{n}{m}{}{r}{}{1}{1} \Big(\getvertices{n}{Single}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{m}} \Big(\alldifferent{} \Big(\getvertices{n}{Single}\Big) \join \alldifferent{} \Big(\expandboth{n}{m}{}{r}{TYPE}{1}{1} \Big(\getvertices{n}{Single}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{b}} \Big(\alldifferent{} \Big(\getvertices{a}{Single}\Big) \join \alldifferent{} \Big(\expandboth{a}{b}{}{\_e226}{}{3}{} \Big(\getvertices{a}{Single}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e226, b} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{r}} \Big(\alldifferent{} \Big(\getvertices{a}{B}\Big) \join \alldifferent{} \Big(\expandboth{a}{a}{B}{r}{}{1}{1} \Big(\getvertices{a}{B}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{b},~\var{r}} \Big(\alldifferent{} \Big(\getvertices{a}{NotThere}\Big) \join \alldifferent{} \Big(\getvertices{b}{B}\Big) \join \alldifferent{} \Big(\expandout{b}{a}{NotThere}{r}{NOR\_THIS}{1}{1} \Big(\getvertices{b}{B}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{b},~\var{r}} \Big(\alldifferent{} \Big(\getvertices{a}{NotThere}\Big) \join \alldifferent{} \Big(\getvertices{b}{NotThere}\Big) \join \alldifferent{} \Big(\expandout{b}{a}{NotThere}{r}{NOR\_THIS}{1}{1} \Big(\getvertices{b}{NotThere}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \topp{2}{} \Big(\projection{\var{n}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a}\assign \var{ColumnName}} \Big(\alldifferent{} \Big(\getvertices{a}{}\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \topp{0}{} \Big(\projection{\var{n}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \sort{\desc \var{id}} \Big(\duplicateelimination \Big(\projection{\var{n.id}\assign \var{id}} \Big(\alldifferent{} \Big(\getvertices{n}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a.id}\assign \var{a},~\var{a.id}} \Big(\alldifferent{} \Big(\getvertices{a}{}\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a}\assign \var{a}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big)\Big) \union \projection{\var{b}\assign \var{a}} \Big(\alldifferent{} \Big(\getvertices{b}{B}\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{a},~\var{b2}} \Big(\alldifferent{} \Big(\expandout{a}{b1}{}{\_e249}{X}{1}{1} \Big(\getvertices{a}{S}\Big)\Big) \join \alldifferent{} \Big(\expandout{a}{b2}{}{\_e250}{Y}{1}{1} \Big(\getvertices{a}{S}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e249, b1, \_e250, b2} \rangle$
			}
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e249, b1} \rangle$
			}
[
	{$\expandout{a}{b1}{}{\_e249}{X}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e249, b1} \rangle$
			}
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e250, b2} \rangle$
			}
[
	{$\expandout{a}{b2}{}{\_e250}{Y}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e250, b2} \rangle$
			}
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e253}{LIKES}{0}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e253, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e254}{LIKES}{1}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e254, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e255}{LIKES}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e255, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e256}{LIKES}{0}{2} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e256, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e257}{LIKES}{1}{2} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e257, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e258}{LIKES}{0}{0} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e258, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e259}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e259, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e260}{LIKES}{2}{2} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e260, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e261}{LIKES}{2}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e261, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e262}{LIKES}{1}{0} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e262, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e266}{LIKES}{0}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e266, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e267}{LIKES}{1}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e267, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{a}{c}{}{\_e268}{LIKES}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e268, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e269}{c}{}{\_e271}{LIKES}{1}{1} \Big(\expandout{a}{\_e269}{}{\_e270}{LIKES}{0}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e270, \_e269, \_e271, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e269}{c}{}{\_e271}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e270, \_e269, \_e271, c} \rangle$
			}
[
	{$\expandout{a}{\_e269}{}{\_e270}{LIKES}{0}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e270, \_e269} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e272}{c}{}{\_e274}{LIKES}{0}{} \Big(\expandout{a}{\_e272}{}{\_e273}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e273, \_e272, \_e274, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e272}{c}{}{\_e274}{LIKES}{0}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e273, \_e272, \_e274, c} \rangle$
			}
[
	{$\expandout{a}{\_e272}{}{\_e273}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e273, \_e272} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e275}{c}{}{\_e277}{LIKES}{1}{1} \Big(\expandout{a}{\_e275}{}{\_e276}{LIKES}{1}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e276, \_e275, \_e277, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e275}{c}{}{\_e277}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e276, \_e275, \_e277, c} \rangle$
			}
[
	{$\expandout{a}{\_e275}{}{\_e276}{LIKES}{1}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e276, \_e275} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e278}{c}{}{\_e280}{LIKES}{1}{} \Big(\expandout{a}{\_e278}{}{\_e279}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e279, \_e278, \_e280, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e278}{c}{}{\_e280}{LIKES}{1}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e279, \_e278, \_e280, c} \rangle$
			}
[
	{$\expandout{a}{\_e278}{}{\_e279}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e279, \_e278} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e281}{c}{}{\_e283}{LIKES}{1}{1} \Big(\expandout{a}{\_e281}{}{\_e282}{LIKES}{2}{} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e282, \_e281, \_e283, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e281}{c}{}{\_e283}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e282, \_e281, \_e283, c} \rangle$
			}
[
	{$\expandout{a}{\_e281}{}{\_e282}{LIKES}{2}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e282, \_e281} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e284}{c}{}{\_e286}{LIKES}{2}{} \Big(\expandout{a}{\_e284}{}{\_e285}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e285, \_e284, \_e286, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e284}{c}{}{\_e286}{LIKES}{2}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e285, \_e284, \_e286, c} \rangle$
			}
[
	{$\expandout{a}{\_e284}{}{\_e285}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e285, \_e284} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e287}{c}{}{\_e289}{LIKES}{3}{} \Big(\expandout{a}{\_e287}{}{\_e288}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e288, \_e287, \_e289, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e287}{c}{}{\_e289}{LIKES}{3}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e288, \_e287, \_e289, c} \rangle$
			}
[
	{$\expandout{a}{\_e287}{}{\_e288}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e288, \_e287} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e290}{c}{}{\_e292}{LIKES}{3}{} \Big(\expandin{a}{\_e290}{}{\_e291}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e291, \_e290, \_e292, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandout{\_e290}{c}{}{\_e292}{LIKES}{3}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e291, \_e290, \_e292, c} \rangle$
			}
[
	{$\expandin{a}{\_e290}{}{\_e291}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e291, \_e290} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandboth{\_e293}{c}{}{\_e295}{LIKES}{3}{} \Big(\expandout{a}{\_e293}{}{\_e294}{LIKES}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e294, \_e293, \_e295, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\expandboth{\_e293}{c}{}{\_e295}{LIKES}{3}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e294, \_e293, \_e295, c} \rangle$
			}
[
	{$\expandout{a}{\_e293}{}{\_e294}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, \_e294, \_e293} \rangle$
			}
[
	{$\getvertices{a}{A}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e298}{c}{}{r}{LIKES}{2}{} \Big(\expandout{\_e296}{\_e298}{}{\_e299}{LIKES}{1}{1} \Big(\expandout{p}{\_e296}{}{\_e297}{LIKES}{1}{} \Big(\getvertices{p}{}\Big)\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, p, \_e297, \_e296, \_e299, \_e298, r, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e297, \_e296, \_e299, \_e298, r, c} \rangle$
			}
[
	{$\expandout{\_e298}{c}{}{r}{LIKES}{2}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e297, \_e296, \_e299, \_e298, r, c} \rangle$
			}
[
	{$\expandout{\_e296}{\_e298}{}{\_e299}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e297, \_e296, \_e299, \_e298} \rangle$
			}
[
	{$\expandout{p}{\_e296}{}{\_e297}{LIKES}{1}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e297, \_e296} \rangle$
			}
[
	{$\getvertices{p}{}$
			\\
...
\begin{flalign*}
& \projection{\var{c.name}} \Big(\alldifferent{} \Big(\getvertices{a}{A}\Big) \join \alldifferent{} \Big(\expandout{\_e302}{c}{}{r}{LIKES}{1}{1} \Big(\expandout{\_e300}{\_e302}{}{\_e303}{LIKES}{2}{} \Big(\expandout{p}{\_e300}{}{\_e301}{LIKES}{1}{1} \Big(\getvertices{p}{}\Big)\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
[
	{$\join$
			\\
			\footnotesize
			$\color{gray} \langle \var{a, p, \_e301, \_e300, \_e303, \_e302, r, c} \rangle$
			}
[
	{$\alldifferent{}$
			\\
...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e301, \_e300, \_e303, \_e302, r, c} \rangle$
			}
[
	{$\expandout{\_e302}{c}{}{r}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e301, \_e300, \_e303, \_e302, r, c} \rangle$
			}
[
	{$\expandout{\_e300}{\_e302}{}{\_e303}{LIKES}{2}{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e301, \_e300, \_e303, \_e302} \rangle$
			}
[
	{$\expandout{p}{\_e300}{}{\_e301}{LIKES}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{p, \_e301, \_e300} \rangle$
			}
[
	{$\getvertices{p}{}$
			\\
...
\begin{flalign*}
& \projection{\var{a},~\var{r},~\var{b}} \Big(\alldifferent{} \Big(\expandout{a}{b}{B}{r}{REL}{1}{1} \Big(\getvertices{a}{A}\Big)\Big) \join \alldifferent{} \Big(\expandout{a}{b}{B}{r}{REL}{1}{1} \Big(\getvertices{a}{A}\Big)\Big)\Big)
 &
\end{flalign*}
