...
[
	{$\alldifferent{}$
			\\
			\footnotesize
			$\color{gray} \langle \var{start, \_e133, \_e132, \_e134, comment, \_e135, person} \rangle$
			}
[
	{$\expandout{comment}{person}{Person}{\_e135}{HAS\_CREATOR}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{start, \_e133, \_e132, \_e134, comment, \_e135, person} \rangle$
			}
[
	{$\expandin{\_e132}{comment}{Comment}{\_e134}{REPLY\_OF}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{start, \_e133, \_e132, \_e134, comment} \rangle$
			}
[
	{$\expandin{start}{\_e132}{}{\_e133}{HAS\_CREATOR}{1}{1}$
			\\
			\footnotesize
			$\color{gray} \langle \var{start, \_e133, \_e132} \rangle$
			}
[
