...
\begin{flalign*}
& \alldifferent{} \Big(\expandout{accountHolder}{contactInformation}{}{\_e307}{}{1}{1} \Big(\getvertices{accountHolder}{AccountHolder}\Big)\Big) \join \alldifferent{} \Big(\expandin{contactInformation}{accountHolder}{AccountHolder}{\_e308}{}{1}{1} \Big(\getvertices{contactInformation}{}\Big) \join \expandout{accountHolder}{unsecuredAccount}{}{r}{HAS\_CREDITCARD \lor HAS\_UNSECUREDLOAN}{1}{1} \Big(\getvertices{accountHolder}{AccountHolder}\Big)\Big)
 &
\end{flalign*}
