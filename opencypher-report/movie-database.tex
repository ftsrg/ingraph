...
\begin{flalign*}
& \projection{\var{a.name},~\var{a.birthplace}} \Big(\alldifferent{} \Big(\expandin{m}{a}{Actor}{\_e339}{ACTS\_IN}{1}{1} \Big(\getvertices{m}{Movie}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{f.name},~\var{m.title},~\var{r.stars},~\var{r.comment}} \Big(\selection{\var{r.stars} > \literal{3}} \Big(\alldifferent{} \Big(\expandout{f}{m}{Movie}{r}{RATED}{1}{1} \Big(\expandboth{u}{f}{Person}{\_e349}{FRIEND}{1}{1} \Big(\getvertices{u}{User}\Big)\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{m.title},~\var{r.stars},~\var{r.comment}} \Big(\selection{\var{r.stars} > \literal{3}} \Big(\alldifferent{} \Big(\expandout{u}{m}{Movie}{r}{RATED}{1}{1} \Big(\getvertices{u}{User}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \topp{10}{} \Big(\projection{\var{people.name}} \Big(\alldifferent{} \Big(\getvertices{people}{Person}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{tom},~\var{tomHanksMovies}} \Big(\alldifferent{} \Big(\expandout{tom}{tomHanksMovies}{}{\_e353}{ACTED\_IN}{1}{1} \Big(\getvertices{tom}{Person}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{directors.name}} \Big(\alldifferent{} \Big(\expandin{cloudAtlas}{directors}{}{\_e354}{DIRECTED}{1}{1} \Big(\getvertices{cloudAtlas}{}\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{coActors.name}} \Big(\alldifferent{} \Big(\expandin{m}{coActors}{}{\_e356}{ACTED\_IN}{1}{1} \Big(\expandout{tom}{m}{}{\_e355}{ACTED\_IN}{1}{1} \Big(\getvertices{tom}{Person}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \duplicateelimination \Big(\projection{\var{hollywood}} \Big(\alldifferent{} \Big(\expandboth{bacon}{hollywood}{}{\_e358}{}{1}{4} \Big(\getvertices{bacon}{Person}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
...
\begin{flalign*}
& \projection{\var{tom},~\var{m},~\var{coActors},~\var{m2},~\var{cruise}} \Big(\alldifferent{} \Big(\expandin{m}{coActors}{}{\_e364}{ACTED\_IN}{1}{1} \Big(\expandout{tom}{m}{}{\_e363}{ACTED\_IN}{1}{1} \Big(\getvertices{tom}{Person}\Big)\Big) \join \expandin{m2}{cruise}{Person}{\_e366}{ACTED\_IN}{1}{1} \Big(\expandout{coActors}{m2}{}{\_e365}{ACTED\_IN}{1}{1} \Big(\getvertices{coActors}{}\Big)\Big)\Big)\Big)
 &
\end{flalign*}
