...
$\projection{\var{a},~\var{b}} \left(\alldifferent{} \left(\expandboth{\_e1}{b}{}{\_e2}{} \left(\expandboth{a}{\_e1}{}{\_e1}{} \left(\getvertices{a}{}\right)\right)\right)\right)$
...
\Tree
[. {$\projection{\var{a},~\var{b}}$ \\ \footnotesize $\color{gray} \langle \var{a, b} \rangle$}
	[. {$\expandboth{\_e1}{b}{}{\_e2}{}$ \\ \footnotesize $\color{gray} \langle \var{a, \_e1, \_e1, \_e2, b} \rangle$}
		[. {$\expandboth{a}{\_e1}{}{\_e1}{}$ \\ \footnotesize $\color{gray} \langle \var{a, \_e1, \_e1} \rangle$}
			[. {$\getvertices{a}{}$ \\ \footnotesize $\color{gray} \langle \var{a} \rangle$}
			]
		]
	]
...
[. {$\projection{\var{a},~\var{b},~\var{c}}$ \\ \footnotesize $\color{gray} \langle \var{a, b, c} \rangle$}
	[. {$\join \{\var{b}\}$ \\ \footnotesize $\color{gray} \langle \var{a, \_e1, \_e1, \_e2, b, r2, c} \rangle$}
		...
		[. {$\selection{\mathtt{r~<>~r2}}$ \\ \footnotesize $\color{gray} \langle \var{b, r2, c} \rangle$}
			[. {$\expandboth{b}{c}{}{r2}{}$ \\ \footnotesize $\color{gray} \langle \var{b, r2, c} \rangle$}
...
\Tree
[. {$\projection{\var{n},~\var{m}}$ \\ \footnotesize $\color{gray} \langle \var{n, m} \rangle$}
	[. {$\expandout{n}{m}{Z}{\_e1}{T}$ \\ \footnotesize $\color{gray} \langle \var{n, \_e1, m} \rangle$}
