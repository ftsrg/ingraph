...
where
    ...
    m_creationdate >= TIMESTAMP 'epoch' + 1338508800000 * INTERVAL '1 ms' and  m_creationdate < (TIMESTAMP 'epoch' + 1338508800000 * INTERVAL '1 ms' + INTERVAL '1 days' * 28) and
    not exists (
        select * from
  (select distinct mt_tagid from message, message_tag, knows
	...
	k_person1id = 10995116278874 and
        ...
        m_creationdate < TIMESTAMP 'epoch' + 1338508800000 * INTERVAL '1 ms') tags
