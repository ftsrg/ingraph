...
/**
 * Pattern-specific match representation of the ingraph.cypher2relalg.queries.edgeVariables pattern,
 * to be used in conjunction with {@link EdgeVariablesMatcher}.
 * 
...
public abstract class EdgeVariablesMatch extends BasePatternMatch {
  private Variable fVariable;
  
  private static List<String> parameterNames = makeImmutableList("variable");
  
  private EdgeVariablesMatch(final Variable pVariable) {
  ...
  public List<String> parameterNames() {
    return EdgeVariablesMatch.parameterNames;
  }
  ...
  @Override
  public EdgeVariablesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof EdgeVariablesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    EdgeVariablesMatch other = (EdgeVariablesMatch) obj;
  ...
  @Override
  public EdgeVariablesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EdgeVariablesMatch newEmptyMatch() {
   ...
   * 
   */
  public static EdgeVariablesMatch newMutableMatch(final Variable pVariable) {
   ...
   * 
   */
  public static EdgeVariablesMatch newMatch(final Variable pVariable) {
    return new Immutable(pVariable);
  }
  
  private static final class Mutable extends EdgeVariablesMatch {
  ...
  private static final class Immutable extends EdgeVariablesMatch {
