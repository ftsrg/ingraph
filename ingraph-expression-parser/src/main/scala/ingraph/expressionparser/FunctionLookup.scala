...
import relalgfunction.CypherType
import relalgfunction.FunctionCategory
...
object FunctionLookup {
  ...
  import relalgfunction.Function._
  import collection.JavaConverters._

  object RelalgFunction {
    def unapply(arg: Function): Option[Tuple2[FunctionCategory, List[CypherType]]] =
