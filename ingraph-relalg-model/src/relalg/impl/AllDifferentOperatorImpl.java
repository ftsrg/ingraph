 ...
 * @generated
 */
public class AllDifferentOperatorImpl extends AlphaOperatorImpl implements AllDifferentOperator {
	/**
	 ...
	 * @ordered
	 */
	protected EList<EdgeVariable> edgeVariables;
	 ...
	 * @generated
	 */
	public EList<EdgeVariable> getEdgeVariables() {
		if (edgeVariables == null) {
			edgeVariables = new EObjectResolvingEList<EdgeVariable>(EdgeVariable.class, this, RelalgPackage.ALL_DIFFERENT_OPERATOR__EDGE_VARIABLES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RelalgPackage.ALL_DIFFERENT_OPERATOR__EDGE_VARIABLES:
				...
				getEdgeVariables().addAll((Collection<? extends EdgeVariable>)newValue);
				return;
		}
