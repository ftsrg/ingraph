...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Arithmetic Comparison Operator</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see relalg.RelalgPackage#getArithmeticComparisonOperator()
 * @model
 * @generated
 */
public enum ArithmeticComparisonOperator implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Arithmetic Comparison Operator</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ArithmeticComparisonOperator[] VALUES_ARRAY =
		new ArithmeticComparisonOperator[] {
			EQUAL_TO,
			NOT_EQUAL_TO,
			GREATER_THAN,
	...
	/**
	 * A public read-only list of all the '<em><b>Arithmetic Comparison Operator</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ArithmeticComparisonOperator> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Arithmetic Comparison Operator</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ArithmeticComparisonOperator get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ArithmeticComparisonOperator result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Arithmetic Comparison Operator</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ArithmeticComparisonOperator getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ArithmeticComparisonOperator result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Arithmetic Comparison Operator</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ArithmeticComparisonOperator get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ArithmeticComparisonOperator(int value, String name, String literal) {
		this.value = value;
		this.name = name;
