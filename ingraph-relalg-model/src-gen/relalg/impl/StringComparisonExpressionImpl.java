 ...
 * </p>
 * <ul>
 *   <li>{@link relalg.impl.StringComparisonExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringComparisonExpressionImpl extends BinaryExpressionImpl implements StringComparisonExpression {
	 ...
	 * @ordered
	 */
	protected static final StringComparisonOperator OPERATOR_EDEFAULT = StringComparisonOperator.MATCHES;
	...
	protected EClass eStaticClass() {
		return RelalgPackage.Literals.STRING_COMPARISON_EXPRESSION;
	}
	...
	public void setOperator(StringComparisonOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelalgPackage.STRING_COMPARISON_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RelalgPackage.STRING_COMPARISON_EXPRESSION__OPERATOR:
				return getOperator();
		}
