...
class TrainBenchmarkUtil {
	...
	def static posLength() {
		val containerr = createRelationalAlgebraContainer

		val segmentLabel = createVertexLabel => [name = "Segment"; it.containerr = containerr]
		val segment = createVertexVariable => [
			name = "segment"
			vertexLabel = segmentLabel
			it.containerr = containerr
		]
		val length = createAttributeVariable => [name = "length"; element = segment; it.containerr = containerr]	
...
//			it.condition = condition
		...
		containerr.rootExpression = production
		containerr
	}
	...
	def static routeSensor() {
		...
		val routeLabel = createVertexLabel => [name = "Route"; it.containerr = containerr]
		val sensorLabel = createVertexLabel => [name = "Sensor"; it.containerr = containerr]
		val switchLabel = createVertexLabel => [name = "Switch"; it.containerr = containerr]
		val switchPositionLabel = createVertexLabel => [name = "SwitchPosition"; it.containerr = containerr]

		val followsLabel = createEdgeLabel => [name = "follows"; it.containerr = containerr]
		val gathersLabel = createEdgeLabel => [name = "gathers"; it.containerr = containerr]
		val monitoredByLabel = createEdgeLabel => [name = "monitoredBy"; it.containerr = containerr]
		val targetLabel = createEdgeLabel => [name = "target"; it.containerr = containerr]

		val route = createVertexVariable => [name = "route"; vertexLabel = routeLabel; it.containerr = containerr]
		val sw = createVertexVariable => [name = "sw"; vertexLabel = switchLabel; it.containerr = containerr]
		val swP = createVertexVariable => [name = "swP"; vertexLabel = switchPositionLabel; it.containerr = containerr]
		val sensor = createVertexVariable => [name = "sensor"; vertexLabel = sensorLabel; it.containerr = containerr]
	...
	def static semaphoreNeighbor() {
		...
		val routeLabel = createVertexLabel => [name = "Route"; it.containerr = containerr]
		val semaphoreLabel = createVertexLabel => [name = "Semaphore"; it.containerr = containerr]
		val sensorLabel = createVertexLabel => [name = "Sensor"; it.containerr = containerr]

		val connectsToLabel = createEdgeLabel => [name = "connectsTo"; it.containerr = containerr]
		val entryLabel = createEdgeLabel => [name = "entry"; it.containerr = containerr]
		val exitLabel = createEdgeLabel => [name = "exit"; it.containerr = containerr]
		val gathersLabel = createEdgeLabel => [name = "gathers"; it.containerr = containerr]
		val monitoredByLabel = createEdgeLabel => [name = "monitoredBy"; it.containerr = containerr]

		val route1 = createVertexVariable => [name = "route1"; vertexLabel = routeLabel; it.containerr = containerr]
		val route2 = createVertexVariable => [name = "route2"; vertexLabel = routeLabel; it.containerr = containerr]
		val semaphore = createVertexVariable => [
			name = "semaphore";
			vertexLabel = semaphoreLabel;
			it.containerr = containerr
		]
		val sensor1 = createVertexVariable => [name = "sensor1"; vertexLabel = sensorLabel; it.containerr = containerr]
		val sensor2 = createVertexVariable => [name = "sensor"; vertexLabel = sensorLabel; it.containerr = containerr]
		val te1 = createVertexVariable => [name = "te1"; it.containerr = containerr]
		val te2 = createVertexVariable => [name = "te2"; it.containerr = containerr]

		val _e1 = createEdgeVariable => [name = "_e1"; edgeLabel = exitLabel; dontCare = true; it.containerr = containerr]
		val _e2 = createEdgeVariable => [
			name = "_e2";
			edgeLabel = gathersLabel;
			dontCare = true;
		...
		val _e7 = createEdgeVariable =>
			[name = "_e7"; edgeLabel = entryLabel; dontCare = true; it.containerr = containerr]
...
//			it.condition = condition
	...
	def static switchSet() {
		...
		val currentPosition = createAttributeVariable => [name = "currentPosition"; element = sw; it.containerr = containerr]
		val position = createAttributeVariable => [name = "position"; element = swP; it.containerr = containerr]
		val signal = createAttributeVariable => [name = "signal"; element = semaphore; it.containerr = containerr]
		
		val _e1 = createEdgeVariable => [
			name = "_e1"; 
			edgeLabel = entryLabel;
			dontCare = true; it.containerr = containerr
		]
		val _e2 = createEdgeVariable => [
			name = "_e2";
			edgeLabel = followsLabel;
