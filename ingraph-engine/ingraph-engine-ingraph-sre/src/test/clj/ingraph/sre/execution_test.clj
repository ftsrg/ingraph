...
(def ^IngraphVertex person0 (IngraphVertex. 0
                                            (-> (HashSet.)
                                                (.$plus "person"))
                                            (-> (HashMap.)
                                                (.$plus (Tuple2. "name" "Andy"))
                                                (.$plus (Tuple2. "age" 24)))))
(def ^IngraphVertex person1 (IngraphVertex. 1
                                            (-> (HashSet.)
                                                (.$plus "person"))
                                            (-> (HashMap.)
...
(def ^IngraphVertex person2 (IngraphVertex. 2
                                            (-> (HashSet.)
                                                (.$plus "person"))
                                            (-> (HashMap.)
...
(def ^IngraphEdge p0-knows-p1 (IngraphEdge. 3
                                            person0
                                            person1
                                            "knows"
                                            (-> (HashMap.)
...
(def ^IngraphEdge p1-knows-p0 (IngraphEdge. 4
                                            person1
                                            person0
                                            "knows"
                                            (-> (HashMap.)
...
(def ^IngraphEdge p0-ch-p2 (IngraphEdge. 5
                                         person0
                                         person2
                                         "child"
                                         (-> (HashMap.))))
