...
public class GetEdgesTask implements Task {
  ...
  public GetEdgesTask(final VertexVariable sourceVar, final AbstractEdgeVariable edgeVar, final VertexVariable targetVar) {
    super();
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    GetEdgesTask other = (GetEdgesTask) obj;
