...
/**
 * A pattern-specific query specification that can instantiate TransitiveExpandOperatorMatcher in a type-safe way.
 * 
...
public final class TransitiveExpandOperatorQuerySpecification extends BaseGeneratedEMFQuerySpecification<TransitiveExpandOperatorMatcher> {
  private TransitiveExpandOperatorQuerySpecification() {
  ...
  @Override
  protected TransitiveExpandOperatorMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TransitiveExpandOperatorMatcher.on(engine);
  }
  
  @Override
  public TransitiveExpandOperatorMatcher instantiate() throws ViatraQueryException {
    return TransitiveExpandOperatorMatcher.create();
  }
  
  @Override
  public TransitiveExpandOperatorMatch newEmptyMatch() {
    return TransitiveExpandOperatorMatch.newEmptyMatch();
  }
  
  @Override
  public TransitiveExpandOperatorMatch newMatch(final Object... parameters) {
    return TransitiveExpandOperatorMatch.newMatch((relalg.Operator) parameters[0], (relalg.ExpandOperator) parameters[1], (relalg.Operator) parameters[2], (relalg.EdgeListVariable) parameters[3]);
  }
  ...
  private static class LazyHolder {
    private final static TransitiveExpandOperatorQuerySpecification INSTANCE = new TransitiveExpandOperatorQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TransitiveExpandOperatorQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final PParameter parameter_pEdgeListVariable = new PParameter("edgeListVariable", "relalg.EdgeListVariable", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://ingraph/relalg", "EdgeListVariable")), PParameterDirection.INOUT);
    
    private final List<PParameter> parameters = Arrays.asList(parameter_pInputOperator, parameter_pExpandOperator, parameter_pParentOperator, parameter_pEdgeListVariable);
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("inputOperator","expandOperator","parentOperator","edgeListVariable");
    }
