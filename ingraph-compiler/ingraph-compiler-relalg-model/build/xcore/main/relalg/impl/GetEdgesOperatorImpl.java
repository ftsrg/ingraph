 ...
 * </p>
 * <ul>
 *   <li>{@link relalg.impl.GetEdgesOperatorImpl#getExpressionContainer <em>Expression Container</em>}</li>
 *   <li>{@link relalg.impl.GetEdgesOperatorImpl#getText <em>Text</em>}</li>
 *   <li>{@link relalg.impl.GetEdgesOperatorImpl#getDirection <em>Direction</em>}</li>
 ...
 * @generated
 */
public class GetEdgesOperatorImpl extends NullaryOperatorImpl implements GetEdgesOperator {
	/**
	...
	public RelalgContainer getExpressionContainer() {
		if (eContainerFeatureID() != RelalgPackage.GET_EDGES_OPERATOR__EXPRESSION_CONTAINER) return null;
	...
	public NotificationChain basicSetExpressionContainer(RelalgContainer newExpressionContainer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newExpressionContainer, RelalgPackage.GET_EDGES_OPERATOR__EXPRESSION_CONTAINER, msgs);
		return msgs;
	}
	...
	public void setExpressionContainer(RelalgContainer newExpressionContainer) {
		if (newExpressionContainer != eInternalContainer() || (eContainerFeatureID() != RelalgPackage.GET_EDGES_OPERATOR__EXPRESSION_CONTAINER && newExpressionContainer != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RelalgPackage.GET_EDGES_OPERATOR__EXPRESSION_CONTAINER, newExpressionContainer, newExpressionContainer));
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelalgPackage.GET_EDGES_OPERATOR__TEXT, oldText, text));
	}
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelalgPackage.GET_EDGES_OPERATOR__DIRECTION, oldDirection, direction));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RelalgPackage.GET_EDGES_OPERATOR__EXPRESSION_CONTAINER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RelalgPackage.GET_EDGES_OPERATOR__TEXT:
				return getText();
			case RelalgPackage.GET_EDGES_OPERATOR__DIRECTION:
				return getDirection();
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Expression.class) {
			switch (derivedFeatureID) {
				case RelalgPackage.GET_EDGES_OPERATOR__EXPRESSION_CONTAINER: return RelalgPackage.EXPRESSION__EXPRESSION_CONTAINER;
				case RelalgPackage.GET_EDGES_OPERATOR__TEXT: return RelalgPackage.EXPRESSION__TEXT;
				default: return -1;
			}
		}
		if (baseClass == NavigationDescriptor.class) {
			switch (derivedFeatureID) {
				case RelalgPackage.GET_EDGES_OPERATOR__DIRECTION: return RelalgPackage.NAVIGATION_DESCRIPTOR__DIRECTION;
				case RelalgPackage.GET_EDGES_OPERATOR__SOURCE_VERTEX_VARIABLE: return RelalgPackage.NAVIGATION_DESCRIPTOR__SOURCE_VERTEX_VARIABLE;
				case RelalgPackage.GET_EDGES_OPERATOR__EDGE_VARIABLE: return RelalgPackage.NAVIGATION_DESCRIPTOR__EDGE_VARIABLE;
				case RelalgPackage.GET_EDGES_OPERATOR__TARGET_VERTEX_VARIABLE: return RelalgPackage.NAVIGATION_DESCRIPTOR__TARGET_VERTEX_VARIABLE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Expression.class) {
			switch (baseFeatureID) {
				case RelalgPackage.EXPRESSION__EXPRESSION_CONTAINER: return RelalgPackage.GET_EDGES_OPERATOR__EXPRESSION_CONTAINER;
				case RelalgPackage.EXPRESSION__TEXT: return RelalgPackage.GET_EDGES_OPERATOR__TEXT;
				default: return -1;
			}
		}
		if (baseClass == NavigationDescriptor.class) {
			switch (baseFeatureID) {
				case RelalgPackage.NAVIGATION_DESCRIPTOR__DIRECTION: return RelalgPackage.GET_EDGES_OPERATOR__DIRECTION;
				case RelalgPackage.NAVIGATION_DESCRIPTOR__SOURCE_VERTEX_VARIABLE: return RelalgPackage.GET_EDGES_OPERATOR__SOURCE_VERTEX_VARIABLE;
				case RelalgPackage.NAVIGATION_DESCRIPTOR__EDGE_VARIABLE: return RelalgPackage.GET_EDGES_OPERATOR__EDGE_VARIABLE;
				case RelalgPackage.NAVIGATION_DESCRIPTOR__TARGET_VERTEX_VARIABLE: return RelalgPackage.GET_EDGES_OPERATOR__TARGET_VERTEX_VARIABLE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == RelalgModelElement.class) {
			switch (baseOperationID) {
				case RelalgPackage.RELALG_MODEL_ELEMENT___FULL_NAME: return RelalgPackage.GET_EDGES_OPERATOR___FULL_NAME;
				default: return -1;
			}
		}
		if (baseClass == Expression.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RelalgPackage.GET_EDGES_OPERATOR___FULL_NAME:
				return fullName();
		}
