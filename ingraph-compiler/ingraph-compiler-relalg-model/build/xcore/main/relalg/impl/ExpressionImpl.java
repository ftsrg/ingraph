 ...
 * </p>
 * <ul>
 *   <li>{@link relalg.impl.ExpressionImpl#getExpressionContainer <em>Expression Container</em>}</li>
 *   <li>{@link relalg.impl.ExpressionImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ExpressionImpl extends RelalgModelElementImpl implements Expression {
	/**
	...
	protected EClass eStaticClass() {
		return RelalgPackage.Literals.EXPRESSION;
	}
	...
	public RelalgContainer getExpressionContainer() {
		if (eContainerFeatureID() != RelalgPackage.EXPRESSION__EXPRESSION_CONTAINER) return null;
	...
	public NotificationChain basicSetExpressionContainer(RelalgContainer newExpressionContainer, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newExpressionContainer, RelalgPackage.EXPRESSION__EXPRESSION_CONTAINER, msgs);
		return msgs;
	}
	...
	public void setExpressionContainer(RelalgContainer newExpressionContainer) {
		if (newExpressionContainer != eInternalContainer() || (eContainerFeatureID() != RelalgPackage.EXPRESSION__EXPRESSION_CONTAINER && newExpressionContainer != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RelalgPackage.EXPRESSION__EXPRESSION_CONTAINER, newExpressionContainer, newExpressionContainer));
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelalgPackage.EXPRESSION__TEXT, oldText, text));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RelalgPackage.EXPRESSION__EXPRESSION_CONTAINER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RelalgPackage.EXPRESSION__TEXT:
				return getText();
		}
