...
[. {$\projection{\var{b}}$ \\ \footnotesize $\color{gray} \langle \var{b} \rangle$}
	[. {$\join \{\var{a}, \var{c}\}$ \\ \footnotesize $\color{gray} \langle \var{a, c, \backslash{}_e1, b, \backslash{}_e2} \rangle$}
		...
		[. {$\expandout{\backslash{}_e2}{}{b}{c}{C}$ \\ \footnotesize $\color{gray} \langle \var{a, \backslash{}_e1, b, \backslash{}_e2, c} \rangle$}
