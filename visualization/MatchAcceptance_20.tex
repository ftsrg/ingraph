...
[. {$\projection{\var{x}}$ \\ \footnotesize $\color{gray} \langle \var{x} \rangle$}
	[. {$\selection{\mathtt{length(p)~=~10}}$ \\ \footnotesize $\color{gray} \langle \var{n, \backslash{}_e1, x} \rangle$}
		[. {$\expandout{\backslash{}_e1}{}{n}{x}{}$ \\ \footnotesize $\color{gray} \langle \var{n, \backslash{}_e1, x} \rangle$}
