...
\newcommand{\expandedgevariable}[4]{
	\left[
	  ...
	  \ifstrequal{#3}{1}{
	    ...
	    {\ast \atom{#3} \ldots \atom{\infty}} % minHops = 1 and maxHops != 1
	  }{
	  {\ast \atom{#3} \ldots \atom{#4}} % minHops != 1
%	    \ifstrequal{#4}{1}
...
\newcommand{\transitiveclosureboth}[5]{\transitiveclosurebothop \nagivationbody{#1}{#2}{#3} \edgevariable{#4}{#5}}

\newcommand{\transitiveclosureupop}{\oplus \updownarrow}
\newcommand{\transitiveclosureup}[5]{\transitiveclosureupop \nagivationbody{#1}{#2}{#3} \edgevariable{#4}{#5}}

\newcommand{\transitiveclosuredownop}{\oplus \updownarrow}
\newcommand{\transitiveclosuredown}[5]{\transitiveclosuredownop \nagivationbody{#1}{#2}{#3} \edgevariable{#4}{#5}}
