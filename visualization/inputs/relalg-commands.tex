...
\newcommand{\expandboth}[5]{\expandbothop \edgevariable{#1}{#2} \expandbody{#3}{#4}{#5}}
...
%\setlength{\fboxsep}{.15\fboxsep}
%\newcommand{\alldifferentop}{\boxed{\neq}\,\,}
%\newcommand{\alldifferentop}{\eqvparsl}
