...
public class UnnecessaryJoinMatcher extends BaseMatcher<UnnecessaryJoinMatch> {
   ...
   * 
   */
  public Collection<UnnecessaryJoinMatch> getAllMatches(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator) {
    return rawGetAllMatches(new Object[]{pLeftInputOperator, pEquiJoinLikeOperator, pParentOperator});
  }
   ...
   * 
   */
  public UnnecessaryJoinMatch getOneArbitraryMatch(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator) {
    return rawGetOneArbitraryMatch(new Object[]{pLeftInputOperator, pEquiJoinLikeOperator, pParentOperator});
  }
   ...
   * 
   */
  public boolean hasMatch(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator) {
    return rawHasMatch(new Object[]{pLeftInputOperator, pEquiJoinLikeOperator, pParentOperator});
  }
   ...
   * 
   */
  public int countMatches(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator) {
    return rawCountMatches(new Object[]{pLeftInputOperator, pEquiJoinLikeOperator, pParentOperator});
  }
   ...
   * 
   */
  public void forEachMatch(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator, final IMatchProcessor<? super UnnecessaryJoinMatch> processor) {
    rawForEachMatch(new Object[]{pLeftInputOperator, pEquiJoinLikeOperator, pParentOperator}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator, final IMatchProcessor<? super UnnecessaryJoinMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pLeftInputOperator, pEquiJoinLikeOperator, pParentOperator}, processor);
  }
   ...
   * 
   */
  public UnnecessaryJoinMatch newMatch(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator) {
    return UnnecessaryJoinMatch.newMatch(pLeftInputOperator, pEquiJoinLikeOperator, pParentOperator);
  }
   ...
   * 
   */
  public Set<Operator> getAllValuesOfleftInputOperator(final UnnecessaryJoinMatch partialMatch) {
   ...
   * 
   */
  public Set<Operator> getAllValuesOfleftInputOperator(final EquiJoinLikeOperator pEquiJoinLikeOperator, final Operator pParentOperator) {
   ...
   * 
   */
  public Set<EquiJoinLikeOperator> getAllValuesOfequiJoinLikeOperator(final Operator pLeftInputOperator, final Operator pParentOperator) {
   ...
   * 
   */
  public Set<Operator> getAllValuesOfparentOperator(final Operator pLeftInputOperator, final EquiJoinLikeOperator pEquiJoinLikeOperator) {
  ...
  protected UnnecessaryJoinMatch tupleToMatch(final Tuple t) {
    try {
    	return UnnecessaryJoinMatch.newMatch((Operator) t.get(POSITION_LEFTINPUTOPERATOR), (EquiJoinLikeOperator) t.get(POSITION_EQUIJOINLIKEOPERATOR), (Operator) t.get(POSITION_PARENTOPERATOR));
  ...
  protected UnnecessaryJoinMatch arrayToMatch(final Object[] match) {
    try {
    	return UnnecessaryJoinMatch.newMatch((Operator) match[POSITION_LEFTINPUTOPERATOR], (EquiJoinLikeOperator) match[POSITION_EQUIJOINLIKEOPERATOR], (Operator) match[POSITION_PARENTOPERATOR]);
    } catch(ClassCastException e) {
  ...
  protected UnnecessaryJoinMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UnnecessaryJoinMatch.newMutableMatch((Operator) match[POSITION_LEFTINPUTOPERATOR], (EquiJoinLikeOperator) match[POSITION_EQUIJOINLIKEOPERATOR], (Operator) match[POSITION_PARENTOPERATOR]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
