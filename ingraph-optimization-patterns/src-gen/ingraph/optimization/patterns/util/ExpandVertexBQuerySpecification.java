...
/**
 * A pattern-specific query specification that can instantiate ExpandVertexBMatcher in a type-safe way.
 * 
 * @see ExpandVertexBMatcher
 * @see ExpandVertexBMatch
 * 
 */
@SuppressWarnings("all")
public final class ExpandVertexBQuerySpecification extends BaseGeneratedEMFQuerySpecification<ExpandVertexBMatcher> {
  private ExpandVertexBQuerySpecification() {
   ...
   * 
   */
  public static ExpandVertexBQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected ExpandVertexBMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return ExpandVertexBMatcher.on(engine);
  }
  
  @Override
  public ExpandVertexBMatcher instantiate() throws ViatraQueryException {
    return ExpandVertexBMatcher.create();
  }
  
  @Override
  public ExpandVertexBMatch newEmptyMatch() {
    return ExpandVertexBMatch.newEmptyMatch();
  }
  
  @Override
  public ExpandVertexBMatch newMatch(final Object... parameters) {
    return ExpandVertexBMatch.newMatch((relalg.GetVerticesOperator) parameters[0], (relalg.ExpandOperator) parameters[1], (relalg.Operator) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExpandVertexBQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link ExpandVertexBQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ExpandVertexBQuerySpecification INSTANCE = new ExpandVertexBQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ExpandVertexBQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "ingraph.optimization.patterns.expandVertexB";
    }
