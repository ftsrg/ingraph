...
/**
 * A match processor tailored for the ingraph.optimization.patterns.expandVertexA pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ExpandVertexAProcessor implements IMatchProcessor<ExpandVertexAMatch> {
  /**
  ...
  @Override
  public void process(final ExpandVertexAMatch match) {
